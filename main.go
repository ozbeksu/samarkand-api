...
func main() {
	...
	apiV1.Get("/users/:username/chats/user/:connection", userHandler.HandleGetUserWithChats)
	apiV1.Get("/users/:username/messages/:context", userHandler.HandleGetUserWithMessages)
